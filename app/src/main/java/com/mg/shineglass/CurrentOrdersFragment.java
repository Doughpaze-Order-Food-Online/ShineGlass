...
public class CurrentOrdersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_current_orders, container, false);
        ...
        if (sharedPreferences.getString("current", null) == null) {
            FETCH_DATA();
        } else {
            if (sharedPreferences.getString("current", null).equals("empty")) {
                ...
                list = gson.fromJson(sharedPreferences.getString("current", null), type);
    ...
    private void handleResponse(List<MyOrders> response) {
        ...
        if (response.size() > 0 && response.get(0) != null) {
            ...
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putString("current", "empty");
            editor.apply();
            rvItem.setVisibility(View.GONE);
            empty.setVisibility(View.VISIBLE);
