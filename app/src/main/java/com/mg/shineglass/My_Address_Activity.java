...
public class My_Address_Activity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(My_Address_Activity.this, New_Address_Activity.class);
    ...
    private void handleResponse(BasicResponse response) {
        ...
        Address_Adapter Adapter = new Address_Adapter(list,Quotation,url,Total,Date,true);
        LinearLayoutManager layoutManager = new LinearLayoutManager(My_Address_Activity.this);
